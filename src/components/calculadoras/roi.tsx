            ...
            <div className="grid grid-cols-1 lg:grid-cols-12 gap-8">
                <div className="lg:col-span-4 bg-white dark:bg-slate-900 rounded-[2rem] border border-slate-100 dark:border-slate-800 shadow-card p-8 text-left">
                    ...
                    <div className="space-y-6">
                        <div className="group">
                            <label className="block text-[10px] font-black text-slate-400 uppercase tracking-[0.15em] mb-3 ml-1 group-focus-within:text-primary transition-colors">Investimento Inicial</label>
                        ...
                        <div className="group">
                            <label className="block text-[10px] font-black text-slate-400 uppercase tracking-[0.15em] mb-3 ml-1 group-focus-within:text-primary transition-colors">Retorno Final</label>
                            <div className="relative">
                                <span className="absolute left-5 top-1/2 -translate-y-1/2 text-slate-400 font-bold">R$</span>
                ...
                <div className="lg:col-span-8 flex flex-col gap-6 text-left">
                    {resultado ? (<>
                        <div className={`p-10 rounded-[2rem] shadow-xl relative overflow-hidden ${resultado.roi >= 0 ? 'bg-gradient-to-br from-primary to-blue-600' : 'bg-gradient-to-br from-red-500 to-rose-600'}`}>
                            <p className="text-[10px] font-black text-white/70 uppercase tracking-[0.2em] mb-3 flex items-center gap-2">
                                <span className="w-1.5 h-1.5 bg-white rounded-full animate-pulse"></span>
                                Retorno sobre Investimento
                            </p>
                            <h1 className="text-5xl md:text-6xl font-black text-white tracking-tighter">{formatarPercentual(resultado.roi)}</h1>
                        ...
                        <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
                            ...
                            <div className="bg-white dark:bg-slate-900 p-7 rounded-[2rem] border border-slate-100 dark:border-slate-800 shadow-sm">
                                ...
                                <p className="text-[10px] font-black text-slate-400 uppercase tracking-widest mb-2">ROI Anualizado</p>
                            ...
                            <div className="bg-slate-900 dark:bg-slate-800 p-7 rounded-[2rem] shadow-card">
                                ...
                                <p className="text-[10px] font-bold text-slate-400 uppercase tracking-widest mb-2">Múltiplo</p>
                        ...
                        <div className="h-full flex flex-col items-center justify-center bg-white dark:bg-slate-900 rounded-[2.5rem] border-2 border-dashed border-slate-200 dark:border-slate-800 p-16 text-center">
                            ...
                            <p className="text-slate-500 dark:text-slate-400 font-medium max-w-sm leading-relaxed">Descubra o retorno percentual do seu investimento.</p>
                        </div>
                    )}
                </div>
            </div>
