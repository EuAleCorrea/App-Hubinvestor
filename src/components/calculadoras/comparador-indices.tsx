                ...
                <div className="lg:col-span-8 flex flex-col gap-6 text-left">
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                        <div className="bg-white dark:bg-slate-900 p-7 rounded-[2rem] border border-slate-100 dark:border-slate-800 shadow-sm">
                            ...
                            <p className="text-[10px] font-black text-slate-400 uppercase tracking-widest mb-2">Taxa Real (CDI - IPCA)</p>
                        ...
                        <div className="bg-slate-900 dark:bg-slate-800 p-7 rounded-[2rem] shadow-card">
                            ...
                            <p className="text-[10px] font-bold text-slate-400 uppercase tracking-widest mb-2">Período Analisado</p>
